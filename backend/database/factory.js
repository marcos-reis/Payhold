...
Factory.blueprint("App/Models/Cashback", (faker, i, data) => ({
	...
	percent: faker.floating({ min: 50, max: 1000, fixed: 2 }),
	partner_id: null,
	user_id: null,
	...data,
}));
...
Factory.blueprint("App/Models/Ordercashback", (faker, i, data) => ({
	orderNumber: faker.integer({ min: 50000, max: 59000 }),
	partnersId: null,
	user_id: null,
	valueTotal: faker.floating({ min: 500, max: 1000, fixed: 2 }),
	commissTotal: faker.floating({ min: 50, max: 100, fixed: 2 }),
	valueCashback: faker.floating({ min: 10, max: 50, fixed: 2 }),
	percentCashback: faker.floating({ min: 0, max: 5, fixed: 2 }),
	description: "Pedido",
	...data,
}));
