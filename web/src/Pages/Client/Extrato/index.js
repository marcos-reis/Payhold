...
setFinancials(response.data.user[0].financials)

var total = 0
response.data.user[0].financials.map((v,i)=>  total += v.value)
...
loadData()
  ...
  <h3 className="col-12 ">{balance}</h3>
                 ...
                 <div className="mt-5  col-11 bg-light justify-content-center row">
                  ...
                  {financials.map((v,i)=>(
                    <div className="row mx-0 col-10 my-0 pt-5 justify-content-center" key={v.id}>
